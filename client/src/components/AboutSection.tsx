...
const AboutSection = () => {
  return (
    <section className="w-full px-4 md:px-8 lg:px-16 py-16 md:py-20 lg:py-24 bg-white min-h-screen flex items-center">
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-16">
          ...
          <div className="flex-1 space-y-4 md:space-y-6 lg:space-y-8 w-full">
            ...
            <h3 className="text-lg md:text-xl lg:text-2xl text-black">
